...
export var fallDamage = true

var velocity = Vector3.ZERO

export var gib = true
export var gibHeatlh = -50

var alerted = false
export var viewRange = 20
var alertPosition = null
...
#
#export (Array, PackedScene) var GIBS = [
...
#	]
#
#export (Array, float) var DROP_CHANCE = [50, 15, 5, 10, 4, 10, 50, 0.1, 1, ]
...
#	"res://Entities/Physics_Objects/Arm_Gib.tscn",
#	"res://Entities/Physics_Objects/Head_Gib.tscn"
#]
#
#puppet func remove():
#	queue_free()
